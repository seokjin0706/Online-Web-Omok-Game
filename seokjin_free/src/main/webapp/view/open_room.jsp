...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/open_room.css">
</head>
    ...
    <div class="bg-dark bg-gradient">
        <div class="wrapper">    
            <div class="bg-dark shadow-lg rounded inner-wrapper" style="width: 450px; height: 450px;">
                ...
                <div>
                    <div>                
                        <form action="http://localhost:8080/seokjin_free/RoomServlet?cmd=openroom" method="post">
                            <div class="mb-3">
