    ...
    <div class="bg-dark bg-gradient">
        <div class="wrapper">    
            <div class="bg-dark shadow-lg rounded inner-wrapper" style="width: 450px; height: 450px;">
                ...
                <div>
                    <div>                
                        <h1 class="text-light mb-5">Sign in to 오목 게임</h1>
                        <form action="http://localhost:8080/seokjin_free/UserServlet?cmd=signin" method="post">
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-danger mb-3 bg-dark bg-gradient text-danger" style="width: 100%;">Sign in</button>
                           
                         </form>
                                         
                         <button onclick="location.href='http://localhost:8080/seokjin_free/UserServlet?cmd=join'" type="button" class="btn btn-danger mb-3 bg-dark bg-gradient text-danger" style="width: 100%;">Create an account</button>
